...
//{
//    public class DataBaseInfoBaseWindowEditor : EditorWindow
//    {
//        //주목적은 
...
//        public static DataBaseInfo_Base targetDataBaseInfo;
...
//        {
//            EditorWindow editorWindow = GetWindow(typeof(DataBaseInfoBaseWindowEditor));
...
//            pathTypeContentList = lLcroweUtil.GetEnumDefineStringData<DataBaseEditorUtil.CATPathType>();
//        }

//        private void OnGUI()
//        {
//            //데이터어덯게할지체크
//            targetDataBaseInfo = (DataBaseInfo_Base)EditorGUILayout.ObjectField("현재선택된 게임 데이터베이스", targetDataBaseInfo, typeof(DataBaseInfo_Base), true);
...
//        //데이터보는구역
//        protected virtual void DataDisplaySection()
//        {
//            //이거 나중에 제대로 처리하자구
...
//                {
//                    DataBaseInfo_Base.ResourcesBible tempBible = null;
...
//        //public class MVPInfoEditorUtil
//        //{
//        //    //각 데이터관련해서 처리해주기 
...
//        private void UnitObjectInfoImport(Dictionary<string, object> item, UnitObjectBaseInfo unitObjectInfo)
//        {

//            unitObjectInfo.unitPrefab = item.GetResourcesForComponent<UnitObject_Base>("unitPrefab", DataBaseUtil.CATPathType.UnitObject);
