...
namespace lLCroweTool.Achievement
{
    public class AchievementManager : MonoBehaviourSingleton<AchievementManager>
    {
        ...
        {
            InitAchievementManager(achievementDataBase);
        }
        ...
        public void InitAchievementManager(AchievementDataBase dataBaseInfo)
        {
        ...
        {
            achievementRewardDataBaseBible.TryGetValue(id, out RewardInfo rewardData);
            return rewardData;
        }
    }
    ...
    /// </summary>
    [System.Serializable]
    //public class AchievementData : lLCroweTool.UI.InfinityScroll.CellData
