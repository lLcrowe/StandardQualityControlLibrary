...
namespace lLCroweTool.QC.EditorOnly
{
    ...
    public class RecordIDTagDrawer : PropertyDrawer
    {
        private int index;
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            //게임디비는 하나만 존재해야됨
            AchievementDataBase[] dataBaseInfoArray = lLcroweUtilEditor.GetScriptableObjectFile<AchievementDataBase>(path, "*.asset");
            AchievementDataBase dataBaseInfo = null;
