...
{   
    public class ScoreBoard : MonoBehaviour
    {
        ...
        public class ScoreValueSort : ValueSort, IComparer<ScoreInfo>
        {
            public ScoreValueSort(bool isAsc) : base(isAsc)
            {
            }
        ...
        private static ScoreValueSort scoreValueSort = new ScoreValueSort(false);
        public void SortScoreType(ScoreType sortScoreType)
        {
            ...
            foreach (var item in scoreInfoBible[sortScoreType])
            {
                ...
                var unitIcon = item.unitObject.GetUnitIcon();
