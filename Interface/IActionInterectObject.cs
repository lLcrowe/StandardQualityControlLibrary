...
namespace lLCroweTool
{
    ...
    /// </summary>
    public interface IActionInterectObject<CheckComponentT1, InterectComponentT2> where CheckComponentT1 : Component where InterectComponentT2 : Component
    {
        /// <summary>
        ...
        bool CheckInterectObject(CheckComponentT1 targetObject);

        /// <summary>
        /// 상호작용에 사용할 함수를 정의(순서2)
        /// </summary>
        /// <param name="targetObject">게임오브젝트를 집어넣고 게임오브젝트에서 컴포넌트 추출해서 작동을 권장</param>    
        void InterectObjectAction(CheckComponentT1 targetObjectT1, InterectComponentT2 targetObjectT2);
