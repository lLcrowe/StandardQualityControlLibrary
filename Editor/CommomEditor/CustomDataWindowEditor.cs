...
namespace lLCroweTool.QC.EditorOnly
{
    ...
    public abstract class CustomDataWindowEditor<T> : EditorWindow where T : ScriptableObject, new()
    {
        ...
        //해당되는 데이터
        protected static T targetData;
        private static bool isLoadData = false;//Load데이터인지,로드가 아닌 리셋인지//인스팩터에디터
        private T targetLoadData;
        ...
        public static void SetLoadData(T data)
        {
            targetData = data;
            isLoadData = true;
        }
        ...
        public static void SetShowWindowSetting(Type type)
        {
            ...
            var data = editorWindow as CustomDataWindowEditor<T>;
            data.ResetData();
        }
